...
@section('content')
	...
	<div style="text-align: right; margin-top: 20px;">
		<a href="/admin/bloodlines/new" class="btn btn-success">New</a>
	</div>
			...
			<table class="table table-bordered">
				<thead>
					<tr>
						...
						<th style="width: 50%;" colspan="2">Description</th>
				...
				<tbody>
					@foreach($bloodlines AS $line)
						<tr>
							...
							<td>
								<a href="/admin/bloodlines/edit/{{ $line->id }}" class="btn btn-warning">Edit</a>
								<a href="/admin/bloodlines/delete/{{ $line->id }}" class="btn btn-danger">Delete</a>
							</td>
						</tr>
					@endforeach
				</tbody>
