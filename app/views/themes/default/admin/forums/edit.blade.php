...
@section('content')
	...
	<div class="row">
		<div class="col-md-12" style="margin-top: 20px; text-align: center;">
			{{ Form::model($category, array('url' => '/admin/forums/edit/'.$category->id, 'method' => 'post', 'files' => true)) }}
			    <p>
			         <center><img src="/assets/images/forums/{{ $category->image }}?time()" /></center>
			    </p>
				...
				<p>
				    {{ Form::label('staff', 'Only Staff can create threads:') }}
				    <select name="staff">
				        <option value="0" @if(!$category->staff) selected @endif>No</option>
				        <option value="1" @if($category->staff) selected @endif>Yes</option>
				    </select>
				</p>
