			...
			<table class="table table-bordered">
				<thead>
					<tr>
						...
						<th style="width: 15%;">Bloodline</th>
						<th style="width: 10%;">Horns</th>
						<th style="width: 10%;">Horns (Pointed)</th>
				...
				<tbody>
					@foreach($species AS $specie)
						<tr>
							...
							<td>
								<a href="/admin/species/edit/{{ $specie->id }}" class="btn btn-warning">Edit</a>
								<a href="/admin/species/delete/{{ $specie->id }}" class="btn btn-danger">Delete</a>
							</td>
						</tr>
					@endforeach
				</tbody>
