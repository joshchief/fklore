...
@section('content')
    <nav aria-label="breadcrumb">
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="/forums/view/{{ $thread->forum_id }}" style="color: #53a7e0;">{{ $thread->forum->name }}</a></li>
    ...
    <div class="row align-center topmargin_l">
        <div class="col-md-12">
            <h1><span style="color: #355b7d;"><b>Edit Thread</b></span></h1>
        </div>
    </div>
    ...
    {{ Form::model($thread, array('url' => '/forums/edit-thread/'.$thread->id)) }}
            ...
            <div class="forum-bg">
                <div class="forum-inner">
                    <div class="row inner-padding bottom-border">
                        <div class="col-md-12">
                            <b>Title:</b> {{ Form::text('title', $thread->title, array('class' => 'form-control')) }}
                        </div>
                    </div>
                    ...
                    <div class="row inner-padding">
                        <div class="col-md-12">
                            <b>Post Text:</b> 
                            <textarea class="form-control" name="reply" cols="80" rows="10">{{ $thread->reply }}</textarea>
                        </div>
                    </div>
